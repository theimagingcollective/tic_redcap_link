...
#
# html_title = 'tic_redcap_link v1.0'
...
man_pages = [
    (master_doc, 'tic_redcap_link', 'tic_redcap_link Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tic_redcap_link', 'tic_redcap_link Documentation',
     author, 'tic_redcap_link', 'One line description of project.',
     'Miscellaneous'),
]
